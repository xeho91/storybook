...
Additionally, you can extend your Storybook configuration file (i.e., [`.storybook/main.js`](./overview.mdx#configure-story-rendering)) and provide a configuration field that you can use to define specific variables (e.g., API URLs). For example:

{/* prettier-ignore-start */}

<CodeSnippets path="storybook-main-env-field-config.md" />

...
If you want to run Storybook in IE11, make sure to [disable](../../essentials/index.mdx#disabling-addons) the docs-addon that is part of `@storybook/addon-essentials`, as this currently [causes issues in IE11](https://github.com/storybookjs/storybook/issues/8884).
...
Check out our [source](https://github.com/storybookjs/storybook/blob/release-6-5/lib/core-common/src/utils/babel.ts) to learn more about these plugins.
...
If you need, you can customize the default Babel configuration used by Storybook. Update your [`.storybook/main.js`](../index.mdx#configure-your-storybook-project) and add the `babel` field with the options you want to use:

{/* prettier-ignore-start */}

<CodeSnippets path="storybook-main-custom-babel-config.md" />
...
<CodeSnippets path="storybook-main-babel-mode-v7.md" />

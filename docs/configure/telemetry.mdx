...
* Storybook metadata:
  ...
  * [Addons](https://storybook.js.org/addons/) (e.g., [Essentials](../essentials/introduction.mdx), [Accessibility](https://storybook.js.org/addons/@storybook/addon-a11y/)).
  * [Feature flags](./overview.mdx#feature-flags) (e.g., `buildStoriesJson`).

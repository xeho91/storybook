...
As an example, you can tell Storybook to use the "dark" theme by modifying [`.storybook/manager.js`](../index.mdx#configure-story-rendering):
...
Supposing you have a Storybook theme defined for the main UI in [`.storybook/manager.js`](../index.mdx#configure-story-rendering):

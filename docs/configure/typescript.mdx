...
To make it easier to configure TypeScript handling, use the `typescript` field in your [`.storybook/main.js`](./overview.mdx#configure-story-rendering).

The following code snippets show the fields for you to use with TypeScript:

{/* prettier-ignore-start */}

<CodeSnippets path="storybook-main-add-ts-config.md" />

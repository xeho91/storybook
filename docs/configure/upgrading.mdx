...
* Run the relevant [automigrations](../migration-guide.mdx#automatic-upgrade) factoring in the [breaking changes](../migration-guide.mdx#major-breaking-changes) between your current version and the specified version
...
<Callout variant="info">
  Storybook collects completely anonymous data to help us improve user experience. Participation is optional, and you may [opt-out](./telemetry.mdx#how-to-opt-out) if you'd not like to share any information.
</Callout>

...
| `features`            | Enables Storybook's [additional features](../api/main-config/main-config-features.mdx)<br /> See table below for a list of available features `features: { storyStoreV7: true }`                                                  |

...
* `babel` - custom [babel configuration](./integration/babel.mdx).
...
| `babelModeV7`         | Enables the new [Babel configuration](./integration/babel.mdx#v7-mode) mode for Storybook. <br /> `features: { babelModeV7: true }`                                                                                                    |
...
* [CSF formats](../api/stories/csf.mdx) from version 1 to version 3 are supported. The `storiesOf` construct is not.

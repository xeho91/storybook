...
ArgTypes are a first-class feature in Storybook for specifying the behaviour of [Args](../../writing-stories/args.mdx). By specifying the type of an arg, you constrain the values that it can take and provide information about args that are not explicitly set (i.e., not required).
...
The most concrete realization of argTypes is the [Args Table](../../writing-docs/doc-blocks/doc-block-argstable.mdx) doc block. Each row in the table corresponds to a single argType and the current value of that arg.

![Storybook inferring automatically the argType](../../_assets/api/argstable.png)

## Automatic argType inference

If you are using the Storybook [docs](../../writing-docs/index.mdx) addon (installed by default as part of [essentials](../../essentials/index.mdx)), then Storybook will infer a set of argTypes for each story based on the `component` specified in the [default export](./csf.mdx#default-export) of the CSF file.
...
<CodeSnippets path="storybook-generated-argtypes.md" />
...
<CodeSnippets path="storybook-customize-argtypes.md" />
...
<CodeSnippets path="storybook-merged-argtypes.md" />
...
<Callout variant="info" icon="💡">
  ...
  As with other Storybook properties (e.g., [args](../../writing-stories/args.mdx), [decorators](../../writing-stories/decorators.mdx)), you can also override ArgTypes per story basis.
...
<CodeSnippets path="button-story-project-args-theme.md" />
...
<CodeSnippets path="storybook-argtypes-with-addon.md" />

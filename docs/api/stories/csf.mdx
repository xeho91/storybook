...
<Callout variant="info" icon="💡">
  ...
  If you are writing stories in the older `storiesOf()` syntax, you can find documentation in an [advanced README](https://github.com/storybookjs/storybook/blob/release-6-5/lib/core/docs/storiesOf.md).
...
CSF is supported in all frameworks except React Native, where you should use the [storiesOf API](https://github.com/storybookjs/storybook/blob/release-6-5/lib/core/docs/storiesOf.md) instead.

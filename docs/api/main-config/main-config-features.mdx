...
<CodeSnippets path="main-config-features-build-stories-json.md" />
...
* Custom [`storySort` functions](../../writing-stories/naming-components-and-hierarchy.mdx#sorting-stories) receive more limited arguments.

...
Parameter's specified in a [CSF](../writing-stories/index.mdx#component-story-format) file's meta configuration apply to all stories in that file. They are defined in the `parameters` property of the `meta` (default export):
...
All other parameters are contributed by addons. The [essential addon's](../essentials/index.mdx) parameters are documented on their individual pages:
...
* [Interactions](../essentials/interactions.mdx#parameters)

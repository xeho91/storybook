...
<CodeSnippets path="button-story-with-sample.md" usesCsf3 csf2Path="api/new-frameworks#snippet-button-story-with-sample" />
...
<CodeSnippets path="button-story-hypothetical-example.md" usesCsf3 csf2Path="api/new-frameworks#snippet-button-story-hypothetical-example" />

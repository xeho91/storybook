...
Component Story Format (CSF) is the recommended way to [write stories](../writing-stories/introduction.mdx). It's an [open standard](https://github.com/ComponentDriven/csf) based on ES6 modules that is portable beyond Storybook.
...
For more examples, see [writing stories](../writing-stories/introduction.mdx).
...
Consider Storybook’s ["Button" example](../writing-stories/introduction.mdx#defining-stories) of a text button that logs its click events:
...
For more information on setting up [Docs](../writing-docs/introduction.mdx) and [Actions](../essentials/actions.mdx), see their respective documentation.

...
When [auto-titling](../configure/sidebar-and-urls.mdx#csf-30-auto-titles), prefix used when generating the title for your stories.

## With a custom implementation

<Callout variant="info" icon="💡">
  With [`storyStoreV7`](./main-config-features.mdx#storystorev7) (the default in Storybook 7), Storybook now statically analyzes the configuration file to improve performance. Loading stories with a custom implementation may de-optimize or break this ability.
</Callout>

...
<Callout variant="warning" id="static-dir-deprecation">
  Starting in 6.4 the `-s` flag is deprecated. Instead, use a configuration object in your `.storybook/main.js` file. See the [images and assets documentation](../configure/integration/images-and-assets.mdx#serving-static-files-via-storybook) for more information.
</Callout>

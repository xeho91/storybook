...
Storybook allows you to create rich and extensive [documentation](./introduction.mdx) that will help you and any other stakeholder involved in the development process. Out of the box you have the tooling required to not only write it but also to preview it and build it.
...
It will look for any stories available either in [MDX](./mdx.mdx) or [CSF](../writing-stories/introduction.mdx#component-story-format) and based on the documentation you've added it will display it...

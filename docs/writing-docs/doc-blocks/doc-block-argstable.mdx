...
Storybook Docs automatically generates component args tables for components in supported frameworks. These tables list the arguments ([args for short](../../writing-stories/args.mdx)) of the component, and even integrate with [controls](../../essentials/controls.mdx) to allow you to change the args of the currently rendered story.

<Video src="../../_assets/writing-docs/addon-controls-docs-optimized.mp4" />
...
<CodeSnippets path="button-component-with-proptypes.md" />
...
To use the `ArgsTable` in [DocsPage](../docs-page.mdx#component-parameter), export a component property on your stories metadata:

{/* prettier-ignore-start */}

<CodeSnippets path="my-component-story.md" />
...
<CodeSnippets path="component-story-mdx-argstable-block-for-component.md" />

### Customizing

`ArgsTables` are generated based on an internal data structure called [ArgTypes](../../api/stories/argtypes.mdx). When you define the component's metadata element in your story, Storybook's Docs will automatically extract the ArgTypes based on available properties.
...
| `control`                      | Associates a control for the property. <br /> Read the [Essentials documentation](../../essentials/controls.mdx) to learn more about controls. <br /> `argTypes: { label: { control: { type: 'text'} } }`     |

{/* prettier-ignore-start */}

<CodeSnippets path="component-story-csf-argstable-customization.md" />

{/* prettier-ignore-end */}

<Callout variant="info" icon="💡">

  This API is experimental and may change outside the typical semver release cycle. Read the documentation to learn more about [ArgTypes](../../api/stories/argtypes.mdx).
...
<CodeSnippets path="button-implementation.md" />
...
<CodeSnippets path="button-story-argtypes-with-categories.md" />

{/* prettier-ignore-end */}

![button story with args grouped into categories](../../_assets/writing-docs/button-args-grouped-categories.png)
...
<CodeSnippets path="button-story-argtypes-with-subcategories.md" />

{/* prettier-ignore-end */}

![button story with args grouped into categories](../../_assets/writing-docs/button-args-grouped-subcategories.png)

### Controls

The controls inside an `ArgsTable` are configured in exactly the same way as the [controls](../../essentials/controls.mdx) addon pane. You’ll probably notice the table is very similar! It uses the same component and mechanism behind the scenes.

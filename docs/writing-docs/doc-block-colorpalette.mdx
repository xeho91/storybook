...
![Storybook color palette doc block](../_assets/writing-docs/doc-block-colorpalette-optimized.png)

## Working with MDX

Similar to [`Typeset`](./doc-block-typeset.mdx), the `ColorPalette` Doc Block is also typically used with MDX. It supports additional customization via options. Below are some examples and a table with all the available options.

{/* prettier-ignore-start */}

<CodeSnippets path="colorpalette-doc-block.md" />

...
<Video src="../_assets/writing-docs/addon-docs-optimized.mp4" />

If you're including Storybook in your project for the [first time](https://storybook.js.org/docs/6), we provide you with [DocsPage](./docs-page.mdx), a documentation template that lists all the stories for a component and associated metadata. It infers metadata values based on source code, types and JSDoc comments. If you need, you can customize this page to create your own custom template.
...
You can also create free-form pages for each component using [MDX](./mdx.mdx), a format for simultaneously documenting components and writing stories.

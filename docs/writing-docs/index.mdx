...
If you're including Storybook in your project for the [first time](../index.mdx), we provide you with a [documentation page](./autodocs.mdx) ("Autodocs" for short), positioned near your stories. It's a baseline template automatically generated, listing your existing stories and relevant metadata.

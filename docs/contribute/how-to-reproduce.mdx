...
![Storybook reproduction generator framework selector](../_assets/contribute/storybook-reproductions-framework-selector-optimized.png)

Then, choose the template you want to work with:

![Storybook reproduction generator template](../_assets/contribute/storybook-reproduction-generator-template-optimized.png)

Finally, enter a location for your reproduction:

![Storybook reproduction location](../_assets/contribute/storybook-reproduction-generator-location-optimized.png)
...
Any Storybook reproduction wouldn't be complete without [stories](../writing-stories/introduction.mdx). To help fix your issue faster, we encourage you to include the minimum amount of stories that will replicate your issue.
...
* [Setup Chromatic](https://www.chromatic.com/docs/storybook?utm_source=storybook_website\&utm_medium=link\&utm_campaign=storybook)

...
* For those [without a play function](../writing-stories/introduction.mdx): it verifies whether the story renders without any errors.
...
<CodeSnippets path="storybook-test-runner-install.md" />
...
<CodeSnippets path="storybook-test-runner-execute.md" />
...
| `--coverage`                    | Runs [coverage tests](./test-coverage.mdx) on your stories and components <br /> `test-storybook --coverage`                      |

{/* prettier-ignore-start */}

<CodeSnippets path="storybook-test-runner-execute-with-flags.md" />
...
<CodeSnippets path="storybook-test-runner-execute-with-url.md" />
...
<CodeSnippets path="storybook-test-runner-with-deploy-event-workflow.md" />
...
<CodeSnippets path="storybook-test-runner-local-build-workflow.md" />
...
<CodeSnippets path="storybook-test-runner-hooks-example.md" />
...
<CodeSnippets path="storybook-test-runner-helper-function.md" />

{/* prettier-ignore-end */}

### Stories.json mode

The test-runner transforms your story files into tests when testing a local Storybook. For a remote Storybook, it uses the Storybook's [stories.json](../configure/overview.mdx#feature-flags) file (a static index of all the stories) to run the tests.
...
<CodeSnippets path="storybook-test-runner-with-stories-json.md" />

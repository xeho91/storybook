...
<CodeSnippets path="storybook-addon-storyshots-install.md" />
...
<CodeSnippets path="storybook-storyshots-config.md" />
...
Run your first test. Storyshots will recognize your stories (based on [.storybook/main.js's setup](../configure/story-rendering.mdx)) and save them in the **snapshots** directory.

```shell
npm test storybook.test.js
```

![Successful snapshot tests](../_assets/writing-tests/storyshots-pass.png)

When you make changes to your components or stories, rerun the test to identify the changes to the rendered markup.

![Failing snapshots](../_assets/writing-tests/storyshots-fail.png)
...
<CodeSnippets path="storybook-storyshots-custom-directory.md" />
...
<CodeSnippets path="storybook-storyshots-custom-framework.md" />
...
Storyshots is highly customizable and includes options for various advanced use cases. You can read more in the [addon’s documentation](https://www.npmjs.com/package/@storybook/addon-storyshots).

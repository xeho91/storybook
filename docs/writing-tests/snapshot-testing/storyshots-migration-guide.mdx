...
* A fully functional Storybook configured with one of the [suppported frameworks](../../configure/integration/frameworks.mdx) running the latest stable version (i.e., 7.6 or higher).

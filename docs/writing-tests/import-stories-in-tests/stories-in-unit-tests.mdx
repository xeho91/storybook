...
<IfRenderer renderer="vue">
  ...
  <CodeSnippets path="storybook-testing-library-install.md" />
...
If you intend to test multiple stories in a single test, use the `composeStories` function from the appropriate framework or supported addon. The function will process every component story you've specified, including any [`args`](../../writing-stories/args.mdx) or [`decorators`](../../writing-stories/decorators.mdx) you've defined. For example:

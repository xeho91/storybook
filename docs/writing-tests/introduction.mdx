...
![Stories are tests](../_assets/writing-tests/stories-are-tests-cropped.gif)
...
Storybook also comes with tools, [a test runner](./test-runner.mdx), and [handy integrations](./importing-stories-in-tests.mdx) with the larger JavaScript ecosystem to expand your UI test coverage. These docs detail how you can use Storybook for UI testing.
...
* [**Snapshot tests**](./snapshot-testing.mdx) detect changes in the rendered markup to surface rendering errors or warnings
* [**Import stories in other tests**](./importing-stories-in-tests.mdx) to QA even more UI characteristics

...
![Visually testing a component in Storybook](../_assets/writing-tests/component-visual-testing.gif)
...
For a self-managed alternative to Chromatic, we offer [StoryShots](https://www.npmjs.com/package/@storybook/addon-storyshots). It allows you to run visual tests on stories by integrating with [jest-image-snapshot](https://github.com/storybookjs/storybook/tree/release-6-5/addons/storyshots/storyshots-puppeteer#imagesnapshots).
...
![Chromatic project first build](../_assets/writing-tests/chromatic-first-build-optimized.png)
...
![Chromatic project second build](../_assets/writing-tests/chromatic-second-build-optimized.png)

...
<CodeSnippets path="histogram-story.md" usesCsf3 csf2Path="why-storybook#snippet-histogram-story" />
...
<details>
  ...
  Storybook is packaged as a small, development-only, [workshop](https://bradfrost.com/blog/post/a-frontend-workshop-environment/) that lives alongside your app. Install it by [running a command](./install.mdx).

...
<CodeSnippets path="your-component.md" usesCsf3 csf2Path="get-started/setup#snippet-your-component" />
...
<details>
  ...
  * Specify a custom [Babel configuration](../configure/compilers.mdx#babel) for Storybook. Storybook automatically tries to use your project’s config if it can.

...
Update your Storybook configuration (in [`.storybook/main.js|ts`](../configure/index.mdx#configure-story-rendering)) to include the Essentials addon.
...
|                                | `mdxPluginOptions` | Provides additional configuration options and plugin configuration for [MDX documentation](../writing-docs/mdx.mdx#lack-of-github-flavored-markdown-gfm).  |

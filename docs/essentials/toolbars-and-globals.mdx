...
Storybook has a simple, declarative syntax for configuring toolbar menus. In your [`.storybook/preview.js`](../configure/index.mdx#configure-story-rendering), you can add your own toolbars by creating `globalTypes` with a `toolbar` annotation:
...
<div class="aside">
  💡 As globals are *global* you can *only* set `globalTypes` in [`.storybook/preview.js`](../configure/index.mdx#configure-story-rendering).
</div>
...
For example, suppose you are using `styled-components`. You can add a theme provider decorator to your [`.storybook/preview.js`](../configure/index.mdx#configure-story-rendering) config:
...
In your [`.storybook/preview.js`](../configure/index.mdx#configure-story-rendering), add the following:

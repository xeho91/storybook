...
<div class="aside">
  💡 Make sure to list `@storybook/addon-interactions` **after** the [`@storybook/addon-essentials`](./introduction.mdx) addon (or the [`@storybook/addon-actions`](./actions.mdx) if you've installed it individually).
</div>

...
* [Docs](../writing-docs/introduction.mdx)
...
Update your Storybook configuration (in [`.storybook/main.js`](../configure/overview.mdx#configure-story-rendering)) to include the Essentials addon.
...
If you need to disable any of the Essential's addons, you can do it by changing your [`.storybook/main.js`](../configure/overview.mdx#configure-story-rendering) file.

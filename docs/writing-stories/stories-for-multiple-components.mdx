...
It's useful to write stories that [render two or more components](../writing-stories/index.mdx#stories-for-two-or-more-components) at once if those components are designed to work together. For example, `ButtonGroups`, `Lists`, and `Page` components.
...
<CodeSnippets path="list-story-unchecked.md" usesCsf3 csf2Path="writing-stories/stories-for-multiple-components#snippet-list-story-unchecked" />

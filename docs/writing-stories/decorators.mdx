...
* `argTypes`- Storybook's [argTypes](../api/stories/argtypes.mdx) allow you to customize and fine-tune your stories [`args`](./args.mdx).
...
It is useful to ensure that the story remains a “pure” rendering of the component under test, and any extra HTML or components don't pollute that. In particular the [Source](../writing-docs/doc-blocks/doc-block-source.mdx) Doc Block works best when you do this.

...
<CodeSnippets path="button-story-with-args.md" usesCsf3 csf2Path="writing-stories/args#snippet-button-story-with-args" />
...
<CodeSnippets path="button-story-primary-long-name.md" usesCsf3 csf2Path="writing-stories/args#snippet-button-story-primary-long-name" />
...
<CodeSnippets path="button-story-component-args-primary.md" usesCsf3 csf2Path="writing-stories/args#snippet-button-story-component-args-primary" />
...
<CodeSnippets path="button-story-primary-composition.md" usesCsf3 csf2Path="writing-stories/args#snippet-button-story-primary-composition" />
...
<CodeSnippets path="page-story.md" usesCsf3 csf2Path="writing-stories/args#snippet-page-story" />
...
<details>
  ...
  In Storybook 5 and before we passed the context as the first argument. If you’d like to revert to that functionality set the `parameters.passArgsFirst` parameter in [`.storybook/preview.js`](../configure/index.mdx#configure-story-rendering):

  {/* prettier-ignore-start */}

  <CodeSnippets path="storybook-preview-parameters-old-format.md" />

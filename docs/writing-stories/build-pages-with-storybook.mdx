...
<CodeSnippets path="documentscreen-story-msw-rest-request.md" />
...
<CodeSnippets path="documentscreen-story-msw-graphql-query.md" />
...
<CodeSnippets path="app-story-with-mock.md" />
...
If the same context applies to all `ProfilePage` stories, we can also use a [decorator](./decorators.mdx).

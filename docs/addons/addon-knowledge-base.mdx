...
<Callout variant="info">
  ...
  The color palette implemented by `@storybook/components` is a high-level abstraction of the [`@storybook/theming`](https://github.com/storybookjs/storybook/tree/release-6-5/lib/theming/src) package.

...
This is equivalent to [registering the addon manually](../get-started/browse-stories.mdx#addons) in [`main.js`](../configure/overview.mdx#configure-story-rendering):

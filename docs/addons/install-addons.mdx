...
Next, update [`.storybook/main.js`](../configure/overview.mdx#configure-story-rendering) to the following:

{/* prettier-ignore-start */}

<CodeSnippets path="storybook-main-addon-registration.md" />
...
<CodeSnippets path="storybook-preset-scss.md" />
...
<CodeSnippets path="storybook-main-preset-config.md" />
...
<CodeSnippets path="storybook-preset-configuration.md" />

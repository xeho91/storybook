...
If you want to configure how the composed Storybook behaves, you can disable the `ref` element in your [`.storybook/main.js`](../configure/overview.mdx#configure-story-rendering)

{/* prettier-ignore-start */}

<CodeSnippets path="storybook-main-disable-refs.md" />

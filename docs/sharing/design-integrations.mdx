...
<CodeSnippets path="storybook-main-figma-addon-register.md" />
...
<CodeSnippets path="component-story-figma-integration.md" usesCsf3 csf2Path="sharing/design-integrations#snippet-component-story-figma-integration" />
...
* [Create an addon tutorial](https://storybook.js.org/docs/addons/writing-addons)

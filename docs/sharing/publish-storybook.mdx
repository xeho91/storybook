...
<Video src="../_assets/sharing/storybook-publish-review-optimized.mp4" />
...
But features like [Composition](./storybook-composition.mdx), [embed](./embed.mdx), history, and versioning require tighter integration with Storybook APIs and secure authentication. Your hosting provider may not be capable of supporting these features. Learn about the Component Publishing Protocol (CPP) to see what.

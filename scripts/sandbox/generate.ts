...
import { allTemplates as sandboxTemplates } from '../../code/lib/toolbox/src/sandbox-templates';
...
const sbInit = async (
  ...
  const sbCliBinaryPath = join(__dirname, `../../code/lib/toolbox/bin/index.cjs`);
